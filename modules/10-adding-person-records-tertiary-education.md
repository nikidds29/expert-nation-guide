...
[Early education](09-adding-person-records-early-education.md), with one
difference worth pausing on: this sub-template has **two** required
fields, not one.

![New item screen scrolled to Tertiary education, with the Items icon, Create item, Resource template, Title, Educational institution, and Add and select item all highlighted](../assets/images/adding-person-records-05-tertiary-education-panel.png)
...
![Zoomed view of the Tertiary study panel, showing Title and Degree / qualification / courses both marked Required, alongside Educational institution and Was the degree completed?](../assets/images/adding-person-records-06-tertiary-education-fields.png)
...
[Early education](09-adding-person-records-early-education.md), for example
