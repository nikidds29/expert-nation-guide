...
[Military service](adding-person-records-military-service.md), with a
...
![New item screen scrolled to Military awards, with the Items icon, Create item, Resource template, Class, Title, and Add and select item all highlighted](../assets/images/adding-person-records-19-military-award-panel.png)
