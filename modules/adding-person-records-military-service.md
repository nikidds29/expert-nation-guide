...
![New item screen scrolled to Military service, with the Items icon, Create item, Resource template, Class, Title, and Add and select item all highlighted](../assets/images/adding-person-records-18-military-service-panel.png)
