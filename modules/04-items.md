...
- **The other 16 templates**: Associated person, Death, Digital media item,
  ...
  [Quick reference guide](28-quick-reference-guide.md) for exactly
...
instead when you need to search by a specific field or value, rather
than simply telling Person records apart from everything else.
