...
so on for every field you'll meet in this guide.
...
record's own screen, and any search result, will ever show. Because a
linked sub-record like this one doesn't link back to the Person it
belongs to, it's also the only clue, on this record alone, of whose
education it is, so treating the Title carefully here matters.
