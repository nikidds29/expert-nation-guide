...
This guide walks through building and adding biographical records in
Expert Nation Omeka-S. The biographical record at the centre of this
collection is the Person. 

A Person record doesn't hold a person's whole life on its own. It stores
some details directly (name, dates, and so on), and stores others as links to separate, smaller records: a place, a period of
