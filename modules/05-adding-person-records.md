...
flat, top-level page per field, no parent/child nesting, so nothing gets
tucked away and missed in the sidebar. Add a new bullet to "Continue with
a specific field" below every time a new field page is added.
-->
...
[Person Template Field Reference](property-reference.md).
...
- [Early education: linking a Schooling record](adding-person-records-early-education.md)
- [Tertiary education: linking a Tertiary study record](adding-person-records-tertiary-education.md)
- [Place of birth: linking a Place record](adding-person-records-place-of-birth.md)
- [Life events: linking a Life event record](adding-person-records-life-events.md)
- [Related persons: linking a Relationship record](adding-person-records-related-persons.md)
- [Place of death: linking a Place record](adding-person-records-place-of-death.md)
- [Birth: linking a Life event record](adding-person-records-birth.md)
- [Military service: linking a Military service record](adding-person-records-military-service.md)
- [Military awards: linking a Military award record](adding-person-records-military-award.md)
- [Occupations: linking an Occupation eventlet record](adding-person-records-occupations.md)
- [Professional Association Memberships: linking a Professional association member record](adding-person-records-professional-associations.md)
- [Other events: linking an Eventlet record](adding-person-records-other-events.md)
- [Death: linking a Death record](adding-person-records-death.md)

Still to come: a section on adding media (Thumbnail image, Additional
photograph(s), Documents, and the rest), and a section on the Person
template's URI fields (Contact details or URL, Discovering Anzacs,
and the other external-link fields). Both work differently enough
from the fields above that they need their own walkthrough.
