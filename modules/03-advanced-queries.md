...
TO ADD A SCREENSHOT:
1. Upload the image file to assets/images/ in the repo.
2. Reference it here with:
   ![Alt text describing the screenshot](../assets/images/your-filename.png)
-->
...
For the full label-to-property lookup table, see
