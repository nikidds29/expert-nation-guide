...
![New item screen scrolled to Professional Association Memberships, with the Items icon, "+" and Add value, Resource template, Class, Title, and Professional Association all highlighted](../assets/images/adding-person-records-22-professional-association-panel.png)

Like [Occupations](18-adding-person-records-occupations.md), this is a
...
under [Occupations](18-adding-person-records-occupations.md).
