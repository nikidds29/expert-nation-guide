...
- [Making a Person Findable: linking a record to the People item set](22-adding-person-records-making-a-person-findable.md)
...
[Adding media items](24-adding-media-items.md) and
[Adding links to other resources outside Omeka](25-adding-uri-links.md).
