...
|---|---|
| **Person** | The core biographical record, the record type covered in depth by the rest of this guide. See the [Quick reference guide](../property-reference.md) for every field it has. |
