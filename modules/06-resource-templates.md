...
|---|---|
| **Person** | The core biographical record, the record type covered in depth by the rest of this guide. See the [Quick reference guide](26-quick-reference-guide.md) for every field it has. |
...
[Advanced Queries](25-advanced-queries.md).
