...
|---|---|
| **Person** | The core biographical record, the record type covered in depth by the rest of this guide. See the [Quick reference guide](28-quick-reference-guide.md) for every field it has. |
...
| Organisation | An organisation record, linked from fields Occupation and Professional Association Memberships. |
