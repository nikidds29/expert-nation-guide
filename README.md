...
modules/
  ...
  05-adding-person-records.md              Module 5 intro: creating an item,
                                            choosing the Person template, and
                                            a list of links to each field page
  adding-person-records-early-education.md       Module 5 field pages: each is
  adding-person-records-tertiary-education.md    its own flat, top-level page
  adding-person-records-place-of-birth.md        (no parent/has_children), so
  adding-person-records-life-events.md           nothing sits nested in the
  adding-person-records-related-persons.md       sidebar and gets missed
  adding-person-records-place-of-death.md
  adding-person-records-birth.md
  adding-person-records-military-service.md
  adding-person-records-military-award.md
  adding-person-records-occupations.md
  adding-person-records-professional-associations.md
  adding-person-records-other-events.md
  adding-person-records-death.md
  adding-person-records-media.md                 Placeholder, not yet
  adding-person-records-uris.md                   written (nav_exclude: true)
assets/
  images/
```
